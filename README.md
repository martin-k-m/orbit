...
**Latest release: [v1.3.0](https://github.com/martin-k-m/orbit/releases/latest)** —
or download directly:

| Platform | Download |
| --- | --- |
| 🍎 **macOS** (Apple Silicon) | [`Orbit_1.3.0_aarch64.dmg`](https://github.com/martin-k-m/orbit/releases/download/v1.3.0/Orbit_1.3.0_aarch64.dmg) |
| 🍎 **macOS** (Intel) | [`Orbit_1.3.0_x64.dmg`](https://github.com/martin-k-m/orbit/releases/download/v1.3.0/Orbit_1.3.0_x64.dmg) |
| 🪟 **Windows** (installer) | [`Orbit_1.3.0_x64_en-US.msi`](https://github.com/martin-k-m/orbit/releases/download/v1.3.0/Orbit_1.3.0_x64_en-US.msi) |
| 🪟 **Windows** (setup) | [`Orbit_1.3.0_x64-setup.exe`](https://github.com/martin-k-m/orbit/releases/download/v1.3.0/Orbit_1.3.0_x64-setup.exe) |
| 🐧 **Linux** (portable) | [`Orbit_1.3.0_amd64.AppImage`](https://github.com/martin-k-m/orbit/releases/download/v1.3.0/Orbit_1.3.0_amd64.AppImage) |
| 🐧 **Linux** (Debian/Ubuntu) | [`Orbit_1.3.0_amd64.deb`](https://github.com/martin-k-m/orbit/releases/download/v1.3.0/Orbit_1.3.0_amd64.deb) |

Verify with [`SHA256SUMS.txt`](https://github.com/martin-k-m/orbit/releases/download/v1.3.0/SHA256SUMS.txt).
