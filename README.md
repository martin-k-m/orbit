...
**Latest release: [v1.4.1](https://github.com/martin-k-m/orbit/releases/latest)** —
or download directly:

| Platform | Download |
| --- | --- |
| 🍎 **macOS** (Apple Silicon) | [`Orbit_1.4.1_aarch64.dmg`](https://github.com/martin-k-m/orbit/releases/download/v1.4.1/Orbit_1.4.1_aarch64.dmg) |
| 🍎 **macOS** (Intel) | [`Orbit_1.4.1_x64.dmg`](https://github.com/martin-k-m/orbit/releases/download/v1.4.1/Orbit_1.4.1_x64.dmg) |
| 🪟 **Windows** (installer) | [`Orbit_1.4.1_x64_en-US.msi`](https://github.com/martin-k-m/orbit/releases/download/v1.4.1/Orbit_1.4.1_x64_en-US.msi) |
| 🪟 **Windows** (setup) | [`Orbit_1.4.1_x64-setup.exe`](https://github.com/martin-k-m/orbit/releases/download/v1.4.1/Orbit_1.4.1_x64-setup.exe) |
| 🐧 **Linux** (portable) | [`Orbit_1.4.1_amd64.AppImage`](https://github.com/martin-k-m/orbit/releases/download/v1.4.1/Orbit_1.4.1_amd64.AppImage) |
| 🐧 **Linux** (Debian/Ubuntu) | [`Orbit_1.4.1_amd64.deb`](https://github.com/martin-k-m/orbit/releases/download/v1.4.1/Orbit_1.4.1_amd64.deb) |

Verify with [`SHA256SUMS.txt`](https://github.com/martin-k-m/orbit/releases/download/v1.4.1/SHA256SUMS.txt).
