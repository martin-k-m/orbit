...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center gap-1 rounded-xl border border-white/[0.06] bg-white/[0.03] p-1",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-white/[0.08] data-[state=active]:text-fg data-[state=active]:shadow-soft",
      className,
    )}
    {...props}
  />
